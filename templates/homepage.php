                        ...
                        <div class="col-12 col-lg-8 col-xl-6">
                            <div class="welcome-text">
                                ...
                                <div class="hero-btn-group" data-animation="bounceInDown" data-delay="100ms">
                                    <a href="#" class="btn alime-btn mb-3 mb-sm-0 mr-4">Read full story</a>
    ...
    <div class="alime-portfolio-area section-padding-80 clearfix">
        <div class="container-fluid">
                ...
                <div class="col-12">
                    ...
                    <div class="alime-projects-menu">
                        <div class="portfolio-menu text-center">
                            <button class="btn active" data-filter=".about-me">About me</button>
                            <button class="btn" data-filter=".about-site">About this site</button>
                            <button class="btn" data-filter=".more">More</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row alime-portfolio">
                ...
                <!-- Single Gallery Item -->
                <div class="col-md-12 single_gallery_item more mb-30 wow fadeInUp" data-wow-delay="500ms">
                    <div class="single-portfolio-content">
